...
def switch_tests():
    ...
    s.expect(PacketInputEvent("eth1", reqpkt, display=Ethernet), "An Ethernet frame from 20:00:00:00:00:01 to 10:00:00:00:00:02 should arrive on eth2")
    ...
    # test case 1: A -> C
    reqpkt = mk_pkt("50:00:00:00:00:01", "20:00:00:00:00:03", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth1", reqpkt, display=Ethernet), "An Ethernet frame from 50:00:00:00:00:01 to 20:00:00:00:00:03 should arrive on eth1")
    ...
    # test case 2: C -> A
    reqpkt = mk_pkt("20:00:00:00:00:03", "30:00:00:00:00:01", '172.16.42.2','192.168.1.100')
    s.expect(PacketInputEvent("eth3", reqpkt, display=Ethernet), "An Ethernet frame from 20:00:00:00:00:03 to 30:00:00:00:00:01 should arrive on eth3")
    s.expect(PacketOutputEvent("eth1", reqpkt, "eth2", reqpkt, display=Ethernet), "Should be flooded out eth1 and eth2")
    
    # test case 1: A -> C
    reqpkt = mk_pkt("30:00:00:00:00:01", "20:00:00:00:00:03", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth1", reqpkt, display=Ethernet), "An Ethernet frame from 30:00:00:00:00:01 to 20:00:00:00:00:03 should arrive on eth1")
    s.expect(PacketOutputEvent("eth3", reqpkt, display=Ethernet), "Ethernet frame destined for 20:00:00:00:00:03 should be forwarded to eth3")
    ...
    # test case 1: C -> A
    reqpkt = mk_pkt("60:00:00:00:00:03", "40:00:00:00:00:01", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth3", reqpkt, display=Ethernet), "An Ethernet frame from 60:00:00:00:00:03 to 40:00:00:00:00:01 should arrive on eth3")
    s.expect(PacketOutputEvent("eth1", reqpkt, "eth2", reqpkt, display=Ethernet), "Should be flooded out eth1 and eth2")
    #time.sleep(15)
